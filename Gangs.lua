return {
    {
        ...
        Items = {"DoubleJump","Mundo","Kunai","SocoEletrico","PISOLUASEVENTO","dismantelar","CollateralRuin","soco","SusanooT"},
    },
  	{
		Grupo = 35831920,
		MinRank = 5,
		GangNome = "Caçadores De Onis",
		MaxHealth = 1000,
		Nome = { Letraakakakaka = Color3.fromRGB(255, 170, 0), Borda = Color3.fromRGB(0, 0, 0) },
		Patente = { Letraakakakaka = Color3.fromRGB(255, 170, 0), Borda = Color3.fromRGB(0, 0, 0) },
		Team = { Letraakakakaka = Color3.fromRGB(255, 170, 0), Borda = Color3.fromRGB(255, 170, 0) },
